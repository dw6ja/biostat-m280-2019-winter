...
The output is the filenmame under the directory `/home/m280data/NYCHVS` which contains .csv.
...
For this problem we write a Rscript. Details are wriiten in that script. Here we give the command of running that Rscript.
    ```{bash eval=FALSE}
